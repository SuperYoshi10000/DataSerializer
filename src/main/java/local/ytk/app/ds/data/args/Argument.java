package local.ytk.app.ds.data.args;
...
public class Argument<T> {
    ...
    protected static final List<ArgTypeConverter<?>> converters = List.of(
        tc(Boolean.class, Boolean::valueOf),
        tc(Integer.class, Integer::valueOf),
        tc(Long.class, Long::valueOf),
        tc(Double.class, Double::valueOf),
        tc(Character.class, a -> a.charAt(0)),
        STRING
    );
