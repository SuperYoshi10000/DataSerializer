...
public class TypedMapTag<V, T extends Tag, M extends TypedMapTag<V, T, M>> extends MapTag<T, M> {
    ...
    public static <V, T extends Tag, M extends TypedMapTag<V, T, M>> TypedMapTag<V, T, M> deserialize(ByteBuf buffer) {
